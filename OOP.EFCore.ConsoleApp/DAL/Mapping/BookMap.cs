        ...
        public void Configure(EntityTypeBuilder<Book> builder)
        {
            ...
            builder.HasData(
                new Book { BookId = 1, Title = "Toprak Ana",CategoryId=1 },
                 new Book { BookId = 2, Title = "Gün Olur Asra Bedel", CategoryId = 2 },
                  new Book { BookId = 3, Title = "Elveda Gülsarı", CategoryId = 2 },
                   new Book { BookId = 4, Title = "Erken Gelen Turnalar", CategoryId = 1 },
                    new Book { BookId = 5, Title = "Dişi Kurdun Rüyaları", CategoryId = 2 },
                     new Book { BookId = 6, Title = "Cemile", CategoryId = 3 },
